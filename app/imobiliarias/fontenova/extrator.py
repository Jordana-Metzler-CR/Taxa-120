...
_NORMALIZACOES_TAXA = [
    ...
    (lambda t: 'SEG.' in t and 'INCENDIO' in t and 'BOX' in t,                               'SEG. INCENDIO - BOX'),
    (lambda t: ('SEG.' in t or 'SEGURO' in t) and 'INCENDIO' in t and 'BOX' not in t,        'SEG. INCENDIO'),
    (lambda t: 'SEGURO' in t and 'AREAS' in t,                                               'SEGURO AREAS COMUNS'),
    ...
    (lambda t: 'REVITALIZ' in t and 'BOX' in t,                                              'REVITALIZACAO PREDIOS - BOXES'),
    (lambda t: 'REVITALIZ' in t and 'BOX' not in t,                                          'REVITALIZACAO PREDIO'),
    (lambda t: 'REFORMA' in t and 'FACHADA' in t,                                            'REFORMA FACHADA - DA FRENTE E GRADES'),
    (lambda t: 'BOX - ' in t,                                                                 'BOX'),
    (lambda t: 'DESCONTO' in t and 'SINDICA' not in t and 'PPCI' not in t,                   'DESCONTO'),
    (lambda t: 'RESTAURA' in t and 'PINTURA' in t,                                           'RESTAURAÇAO E PINTURA GRADES ENTORNO DO PREDIO'),
    (lambda t: 'RECUP' in t and ('SALDO' in t or 'DEVEDOR' in t),                            'REC SALDO DEVEDOR'),
    (lambda t: 'RECUP' in t and 'PISO' in t,                                                 'REC PISO E PAREDE'),
    ...
    (lambda t: 'MODER.' in t and 'ELEVADOR' in t,                                            'MODER. ELEVADOR - QUADRO COMANDO'),
]
